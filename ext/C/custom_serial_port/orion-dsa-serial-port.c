...
// create IfSerialPort compatible types
DW_CUSTOM_SERIAL_PORT_EX(OrionDSARS485, OrionRS485Data)

// These ustom serial port functions
// have to be implemented
const char* SP_IMPORT ORION_DAQ_RS485_getPortName(struct _OrionDSARS485*);
BOOL SP_IMPORT ORION_DAQ_RS485_open(struct _OrionDSARS485*);
BOOL SP_IMPORT ORION_DAQ_RS485_isOpen(struct _OrionDSARS485*);
BOOL SP_IMPORT ORION_DAQ_RS485_close(struct _OrionDSARS485*);
int SP_IMPORT ORION_DAQ_RS485_numBytesAvailable(struct _OrionDSARS485*);
BOOL SP_IMPORT ORION_DAQ_RS485_read(struct _OrionDSARS485*, BYTE* buf, size_t buf_size, unsigned int timeout, ReadResult* read_result);
BOOL SP_IMPORT ORION_DAQ_RS485_write(struct _OrionDSARS485*, BYTE* buf, size_t buf_size, unsigned int addr, unsigned int command_id);
unsigned int SP_IMPORT ORION_DAQ_RS485_getBaudRate(struct _OrionDSARS485*);
...
int main(int argc, char* argv[])
{
    ...
    // Initialize vtable
    OrionDSARS485Vtable my_serial_port_vt = {
    ...
    OrionDSARS485  my_serial_port = { &my_serial_port_vt, rs485_data };


    // TODO 
    // Add code to load and configure ORION DSA board + RS485
    if (!RTdaqLoad())
    {
        printf("Error: Could not load ORION DSA API.\n");
        return -1;
    }
    
    if (!RtInitialBoards())
    {
        printf("Error: Could not initialize ORION DSA API.\n");
        return -1;
    }
...
const char* SP_IMPORT ORION_DAQ_RS485_getPortName(struct _OrionDSARS485* self)
{
    return "ORION_DAQ_RS485";
}

BOOL SP_IMPORT ORION_DAQ_RS485_open(struct _OrionDSARS485* self)
{
...
BOOL SP_IMPORT ORION_DAQ_RS485_isOpen(struct _OrionDSARS485* self)
{
    return self->m_data.m_is_open;
}

BOOL SP_IMPORT ORION_DAQ_RS485_close(struct _OrionDSARS485* self)
{
    if (self->m_data.m_is_open)
    {
...
int SP_IMPORT ORION_DAQ_RS485_numBytesAvailable(struct _OrionDSARS485* self)
{
...
BOOL SP_IMPORT ORION_DAQ_RS485_read(struct _OrionDSARS485* self, BYTE* buf, size_t buf_size, unsigned int timeout, ReadResult* read_result)
{
    assert(ORION_DAQ_RS485_isOpen(self));
    int read_len = 0;
    int bytes_available = 0;
...
BOOL SP_IMPORT ORION_DAQ_RS485_write(struct _OrionDSARS485* self, BYTE* buf, size_t buf_size, unsigned int addr, unsigned int command_id)
{
    assert(ORION_DAQ_RS485_isOpen(self));
...
unsigned int SP_IMPORT ORION_DAQ_RS485_getBaudRate(struct _OrionDSARS485* self)
{
